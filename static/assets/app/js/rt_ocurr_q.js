            ...
            function (data_json) {
                ...
                $('#table_q').DataTable({
                    ...
                    columns: [
                        ...
                        {"data": "%_INCU_CLAIMS", render: $.fn.dataTable.render.number(',', '.', 2, '% ')},
                        {"data": "%_PAID_CLAIMS", render: $.fn.dataTable.render.number(',', '.', 2, '% ')},
                        {"data": "%_RBNS_EOP", render: $.fn.dataTable.render.number(',', '.', 2, '% ')},
                        {"data": "%_IBNR_EOP", render: $.fn.dataTable.render.number(',', '.', 2, '% ')},
                        {"data": "%_EC", render: $.fn.dataTable.render.number(',', '.', 2, '% ')},
                        {"data": "%_TCR", render: $.fn.dataTable.render.number(',', '.', 2, '% ')}
                    ],
                    "bDestroy": true,
                    //"order": [[ 1, "desc" ]]
                });
                ...
                //Data Graphs
                data_table = data_json[7];
                data_table_2 = data_json[8];
                        ...
                        [
                            {
                                ...
                                "useLineColorForBulletBorder": true,
                                "valueField": "EP",
                                "balloonText": "[[title]]<br/><b style='font-size: 80%'>[[value]] M </b>"
                            }
                        ],
                    "chartCursor": {
                        "pan": true,
