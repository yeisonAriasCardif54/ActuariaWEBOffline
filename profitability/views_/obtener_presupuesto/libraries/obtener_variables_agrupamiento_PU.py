...
def obtener_variables_agrupamiento_PU(tipincent, ngrupos, meses, mesiniciost, OutPut, data_grupos_pu):
    ...
    OutPut['TEMP_incentig'] = np.where(tipincent == "Pagados", OutPut['incentp'], OutPut['incent'])
    ...
    # cancelag = cancelag.groupby('Id_ Grupo_PU')['cancelaciones'].apply(list)
    ...
    # incentig = incentig.groupby('Id_ Grupo_PU')['TEMP_incentig'].apply(list)

    tmktCostg = OutPut.groupby((['Id_ Grupo_PU', 'TEMP_numeromes']), as_index=False)['tmkCost'].sum().groupby('Id_ Grupo_PU')['tmkCost'].apply(list)
    # tmktCostg = tmktCostg.groupby('Id_ Grupo_PU')['tmkCost'].apply(list)
    ...
    # vatincentg = vatincentg.groupby('Id_ Grupo_PU')['vatincent'].apply(list)

    vatmkg = OutPut.groupby((['Id_ Grupo_PU', 'TEMP_numeromes']), as_index=False)['vatmk'].sum().groupby('Id_ Grupo_PU')['vatmk'].apply(list)
    # vatmkg = vatmkg.groupby('Id_ Grupo_PU')['vatmk'].apply(list)
